        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    Recipiant = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderItemTypes_OrderCarts_OrderCartId",
                        column: x => x.OrderCartId,
                        principalTable: "OrderCarts",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_OrderItemTypes_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_OrderItemTypes_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItemTypes_OrderCartId",
                table: "OrderItemTypes",
                column: "OrderCartId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderItemTypes_OrderId",
                table: "OrderItemTypes",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderItemTypes_UserId",
                table: "OrderItemTypes",
                column: "UserId");
